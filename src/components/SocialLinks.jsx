...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "@abrham_asrat12",
    icon: Instagram,
    url: "https://www.instagram.com/abrham_asrat12",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@abrham-asrat",
    icon: Github,
    url: "https://github.com/abrham-asrat",
    color: "#ffffff",
  ...
  },
  {
    name: "Email",
    displayName: "Email",
    subText: "abrhamasrat29@gmail.com",
    icon: Mail,
    url: "mailto:abrhamasrat29@gmail.com",
    color: "#EA4335",
    gradient: "from-[#EA4335] to-[#EA4335]",
  },
];
...
const SocialLinks = () => {
  ...
  const [instagram, youtube, github, tiktok, telegram, email] = otherLinks;
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Fourth Row - Telegram & Email */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[telegram, email].map((link) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
